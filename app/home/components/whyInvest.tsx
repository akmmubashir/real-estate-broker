    ...
    return (
        <div className='p-[80px_0px_80px] max-xl:p-[60px_40px_60px] max-lg:p-[40px_20px_40px] max-w-300 mx-auto flex flex-col gap-10'>
            ...
            <div className="grid grid-cols-12 items-center gap-10 max-lg:gap-6">
                {data.map((item) => (
                    <div key={item.id} className="group col-span-6 max-lg:col-span-full flex flex-col gap-4 relative h-100 max-lg:h-70 bg-[#f6f3ec] hover:bg-[#d9baa0] transition-all duration-300 rounded-[30px] bg-no-repeat bg-cover bg-center" style={{
                        ...
                        <Link href={"#"} className='absolute  rotate-45 w-13 h-13 right-0 top-0 bg-[#ebebeb] group-hover:bg-[#d9baa0] rounded-full group-hover:scale-110 hover:scale-95! transition-all duration-300 flex justify-center items-center'>
                            <ArrowIcon size="w-6 h-6 m-[15px]" color="stroke-[#3a3a3a]" stroke="2" />
                        </Link>
