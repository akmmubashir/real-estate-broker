...
const HeroSection = () => {
    ...
    return (
        <div className='relative'>
            ...
            <div className='relative z-20 h-dvh max-lg:gap-[40px_0] p-[160px_0px_60px] max-xl:p-[140px_40px_60px] max-lg:p-[160px_20px_40px] max-w-300 mx-auto flex flex-col justify-between'>
