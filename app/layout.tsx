...
export const metadata: Metadata = {
  ...
  description: "DAMAC Properties is your trusted partner for luxury properties in Dubai. Discover your dream home with us.",
  keywords: [
    "DAMAC Properties", "Luxury Properties", "Dubai Real Estate", "Apartments for Sale", "Villas for Sale", "Property Investment", "Real Estate Agency", "Luxury Homes", "Dubai Properties", "Real Estate Listings",
  ],
